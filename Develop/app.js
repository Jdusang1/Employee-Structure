...
function createManager() {
    inquirer.prompt(manager).then(responses => {
        const manager = new Manager(responses.managersName, responses.managersEmail, responses.managersId, responses.managersOffice)
...
function createIntern() {
    inquirer.prompt(intern).then(responses => {
        const intern = new Intern(responses.internName, responses.internId, responses.internEmail, responses.university)
...
function createTeam() {
    inquirer.prompt([
        ...
        .then(responses => {
            switch (responses.secondTeamMember) {
                case "engineer":
                    createEngineer()
                    break;
                case "intern":
